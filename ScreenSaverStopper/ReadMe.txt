================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: ScreenSaverStopper プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した ScreenSaverStopper には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには ScreenSaverStopper アプリケーションを構成している各ファイ
ルの概要説明が含まれます。

ScreenSaverStopper.vcproj
...
ScreenSaverStopper.h
   これはアプリケーションのメイン ヘッダー ファイルです。このファイルには、
   Resource.h を含む、その他のプロジェクト固有のヘッダーが含まれていて、
   CScreenSaverStopperApp アプリケーション クラスを宣言します。

ScreenSaverStopper.cpp
   これは、アプリケーション クラス CScreenSaverStopperApp を含むメイン アプリケー
   ション ソース ファイルです。

ScreenSaverStopper.rc
...
res\ScreenSaverStopper.ico
   これは、アプリケーションのアイコンとして使用されるアイコンファイルです。この
   アイコンはメイン リソース ファイル ScreenSaverStopper.rc に含まれていま
   す。

res\ScreenSaverStopper.rc2
...
StdAfx.h, StdAfx.cpp
   ...
   ScreenSaverStopper.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
